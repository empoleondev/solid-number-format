...
// import { cleanup, render as testRender, fireEvent } from '@solidjs/testing-library';
...
//     await user.keyboard(key);
//   } else {
//     // Unfortunately jsdom do not handle @testing-library/solid user.type event correctly
